...
function DashboardLayoutContent() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("nesa:toolcall", handleToolCall); window.addEventListener("auth:logout", handleLogout); window.addEventListener("nesa:mic_lost", handleMicLost); window.addEventListener("nesa:limit_reached", handleLimitReached);
    return () => { window.removeEventListener("nesa:toolcall", handleToolCall); window.removeEventListener("auth:logout", handleLogout); window.removeEventListener("nesa:mic_lost", handleMicLost); window.removeEventListener("nesa:limit_reached", handleLimitReached); };
