    ...
    try {
      ...
      if (toolCall) {
        ...
        for (const call of calls) {
          ...
          const asyncTools = ["spotlightElement", "clickElement", "navigatePage", "deleteAsset", "exportCallSummary", "getDashboardMetrics", "deleteSession", "previewAsset", "switchSession", "submitStudioPrompt", "controlSidebar", "toggleWorkspaceControl", "generateImage"];
